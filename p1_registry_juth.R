...
source('p1_fig002_juth_arm1.R')

#script for Project1 - luth arm2
source('p1_registry_juth_arm_2.R')

### script for RMD document with LUTH - 'arm_1' and 'arm_2' plots and table with total enrollment by gender

library(knitr)
rmarkdown::render('p1_report003_juth.Rmd', output_dir = 'output', run_pandoc = TRUE)
