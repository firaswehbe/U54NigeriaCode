...
rownames(mytable3) <- c("Luth_arm_1", "Luth_arm_2")
mytable4 <- cbind(
  mytable3,
rowSums(mytable3)
)
...
![Participants enrolled since registry launch - Arm 1](output/fig001_arm1.png)

<p style="page-break-before: always" />

![Participants enrolled since registry launch - Arm 2](output/fig001_arm2.png)
