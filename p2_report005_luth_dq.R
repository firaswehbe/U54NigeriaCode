...
rmarkdown::render('luth_dq_p2.Rmd', output_dir = 'output/luth', run_pandoc = TRUE)
new <- paste("output/luth/luth_dq_p2_",Sys.Date() ,".html",sep = "")
file.rename('output/luth/luth_dq_p2.html', new)
